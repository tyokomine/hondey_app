...
<div class="section2">
	...
	<div class="item_pic">
		<a href="<?php echo $this->Html->url('bookConversation')."/".$sid?>"><img class="product" src="http://ec2.images-amazon.com/images/I/41VPCPBHRNL._SL500_AA300_.jpg"></a>
...
<script type="text/javascript">
	...
	$('#fb_suggest').ajaxSuggest('http://wishalist.com/hondey/ajaxSuggest/<?php echo $sid?>');
