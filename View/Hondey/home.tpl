<header>
	<a href="http://wishalist.com/hondey/home"><img id="hondey" src="http://wishalist.com/img/Hondey_img.png"></a>
	<img id="person_header" src=https://graph.facebook.com/<?php echo $user["member_fb_id"]?>/picture?type=square>
	<div id="hello">
		Hi, <?php echo $user["member_name"]?>!
	</div>
</header>
<div class="section0">
	<div id="myself">
		<a href="#"><?php echo $user["member_name"]?></a>
	</div>
	<div id="friend">
	...
	<div id="book">
		<div id="book-box1">
			<img class="product_recommend" id="book-picture" src="http://wishalist.com/img/book.jpg">
	...
	<div id="arrow">
		<img id="arrow1" src="http://wishalist.com/img/arrow.png">
	</div>
	<div id="whom">
		<div id="whom-box1">
			<img class="person_recommend" id="person-picture" src="http://wishalist.com/img/person.png">
...
<div class="section2">
	<div id="favorite-box">
		<img id="favorite" src="http://wishalist.com/img/star.jpg">
		<div id="favorite2">
			fav
		</div>
	</div>
	<div class="item_pic">
		...
		<span> <?php foreach ($friends as $friend)
			?>
			<!-- 			 <a href="#"><img src =https://graph.facebook.com/{$friend["id"]}/picture?type=square></a> --> <!-- 			  {if $smarty.foreach.namae.iteration > 5}{break}{/if} --> <?php endforeach?></span>
	</div>
...
<div class="section3">
	<div id="conversation-box">
		<img id="conversation" src="http://wishalist.com/img/balloon.png">
...
<div class="section4">
	<div>
		<img id="friend_list" src="http://wishalist.com/img/friends.png">
		<div id="friend1">
			friends
		</div>
	</div>
	...
	<div class="person_pic">
		<a href="#"><img class="person" src =https://graph.facebook.com/<?php echo $friend["id"]?>/picture?type=large></a>
		<span> <a href="#"> <?php echo $friend["name"]?>
			<br> see book </a> </span>
	</div>
	{if $smarty.foreach.namae.iteration > 17}{break}{/if} <?php endforeach?>
</div>
...
<script type="text/javascript">
	...
	//サジェストサーチ用のscript
	$('#amazon_suggest').ajaxSuggestAmazon('http://wishalist.com/hondey/amazonSuggest/');
	$('#fb_suggest').ajaxSuggest('http://wishalist.com/hondey/ajaxSuggest/{$sid}');
