...
<div class="section1">
	<img id="person" src=https://graph.facebook.com/<?php echo $user["member_fb_id"]?>/picture?type=large>
</div>
<div class="section2">
	<div class="box">
		<img class="x-button" src="http://wishalist.com/img/x-button.png">
		<div class="book-box">
			<img class="book1" src="http://wishalist.com/img/book.jpg">
			<div class="drop-here">
				drop here
			</div>
		</div>
	...
	<div class="box">
		<img class="x-button" src="http://wishalist.com/img/x-button.png">
		<div class="book-box">
			<img class="book2" src="http://wishalist.com/img/book.jpg">
			<div class="drop-here">
				drop here
			</div>
		</div>
	...
	<div class="box">
		<img class="x-button" src="http://wishalist.com/img/x-button.png">
		<div class="book-box">
			<img class="book3" src="http://wishalist.com/img/book.jpg">
			<div class="drop-here">
				drop here
			</div>
		</div>
	...
	<div class="box">
		<img class="x-button" src="http://wishalist.com/img/x-button.png">
		<div class="book-box">
			<img class="book4" src="http://wishalist.com/img/book.jpg">
			<div class="drop-here">
				drop here
			</div>
		</div>
	...
	<div class="box">
		<img class="x-button" src="http://wishalist.com/img/x-button.png">
		<div class="book-box">
			<img class="book5" src="http://wishalist.com/img/book.jpg">
			<div class="drop-here">
				drop here
			</div>
		</div>
	</div>
	<form id="finish-button" action="<?php echo $this->Html->url('home')."/".$sid?>">
