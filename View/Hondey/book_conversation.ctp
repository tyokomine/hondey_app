...
<div class="section0">
	...
	<div class="book-info">
		...
		<img id="amazon" src="http://wishalist.com/img/amazon.gif">
	</div>
</div>
<div class="section1">
	<span id="friend-conversation">会話している友だち</span>
	<a href="#"><img class="person-small" src=https://graph.facebook.com/<?php echo $user["member_fb_id"]?>/picture?type=square></a>
...
<div class="section2">
	<div class="balloon">
		<div class="person_box">
			<a href="#"><img class="person" src="https://graph.facebook.com/<?php echo $user["member_fb_id"]?>/picture?type=square"></a>
			<div class="name">
